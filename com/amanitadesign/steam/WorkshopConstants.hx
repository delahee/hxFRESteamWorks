...
@:enum
abstract Visibility(Int) from Int to Int{
	var Public			=	WorkshopConstants.VISIBILITY_Public;
	var FriendsOnly		=	WorkshopConstants.VISIBILITY_FriendsOnly;
	var Private			=	WorkshopConstants.VISIBILITY_Private;
}